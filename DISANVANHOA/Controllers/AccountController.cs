    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                DISANVANHOA.Common.Common.SendMail("AI di sản Tuyên Quang", "Quên Mật Khẩu", "Bạn hãy clik vào link <a href=" + callbackUrl + "> tại đây </a> để lấy lại mật khẩu", model.Email);
